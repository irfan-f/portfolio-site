...
import { rootImages, outdoorImages, gardenImages, cookingImages, bikingImages, placeHolderImages } from "../helpers/images";
...
const placeHolderSectionData: SectionProps = {
  id:"placeholder",
  title: "More to come...",
  content: "I'm always exploring new eateries, recipes, trails, and websites so I'll be sure to keep y'all updated here...",
  orientation: "right",
  style: "tertiary",
