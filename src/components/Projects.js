  ...
  return (
    <React.Fragment>
        <div className="container projects" id="projects">
            ...
            <div className="row">
                <div className="col col-lg-6 col-md-7" id="picOfMe">
                ...
                <div className="col col-lg-6 col-md-7" id="aboutOfMe">
