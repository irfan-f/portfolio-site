...
const IntroText: FC = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-y-1 text-center sm:gap-y-2 md:min-w-0 md:!items-center md:!text-center">
      <p className="font-dosis text-primary dark:text-secondary text-xl sm:text-2xl md:text-3xl lg:text-4xl">
        Hi I'm,
      </p>
      ...
      <TypeWriter
        className="font-mulish text-primary dark:text-secondary text-xl font-semibold sm:text-2xl md:text-3xl lg:text-4xl"
        text={h2Text}
      />
    </div>
  );
